...
class Form(flask_wtf.Form):
    ...
    #Auton Section
    auton_start = RadioField('Robot Starting Location',choices=[('Neutral Zoning of the berlin wall','Neutral Zoning of the berlin wall'), ('Courtyard','Courtyard'), ('minds of moria', 'minds of moria')],
    ...
    auton_end = RadioField('Robot Ending Location', choices=[('the moon', 'the moon'), ('bob', 'bob')],
    						default='the moon')
    ...
    stuff_breach = BreachField('Stuff')
    ...
    defense_rating = RadioField('How well did they play defense? They probably didnt', choices=[('0','Did not Defend'), ('1', 'Bad Defense'), ('2', 'Moderate Defense'), ('3', 'Best Defense')], default="0")
    defense_time = RadioField('How much time did they spend on defense? probably none', choices=[('0', 'No Time'), ('1', 'Less than Half'), ('2', 'Most of the Time'), ('3', 'All Match')], default="0")
